            ...
            if(!empty($request->dari))
            {
                ...
                return DataTables::of($data)
                        ...
                        ->addColumn('action', function($data){
                            ...
                            $actionBtn .= ' <a href="#" class="btn btn-sm btn-outline btn-info" data-slug="'.$data->slug.'" data-nama_diklat="'.$data->program->name.'" data-id="'.asset('images/'.$data->slug.'.png').'" data-toggle="modal" data-target="#modal_scan"><i class="mdi mdi-barcode-scan"></i></a>';
                            return $actionBtn;
                        })

...
class ExportDataPesertaUntukImport implements FromView,ShouldAutoSize
{
    ...
    */
    ...
    public function view(): View
    {
        ...
        return view('tilawatipusat.cetak.cabang.data-peserta-untuk-import',compact('peserta','pelatihan'));
    }
}

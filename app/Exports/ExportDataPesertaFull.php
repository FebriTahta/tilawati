...
class ExportDataPesertaFull implements FromView,ShouldAutoSize
{
    ...
    */
    ...
    public function view(): View
    {
        ...
        return view('tilawatipusat.cetak.cabang.data-peserta-cabang-full',compact('peserta','pelatihan'));
    }
}

...
<html lang="en">
    <head>
        ...
        <link rel="shortcut icon" href="{{asset('assets/images/nf_title.png')}}">
                ...
                <div class="sidebar-inner slimscrollleft">                    
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="dripicons-document"></i><span> Forms </span> <span class="badge badge-warning badge-pill float-right"></span></a>
                            ...
                            <ul class="list-inline float-right mb-0">
                                ...
                                <li class="list-inline-item dropdown notification-list">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated dropdown-menu-lg">
                                        ...
                                        <div class="slimscroll" style="max-height: 230px;">
                                            ...
                                            <!-- item-->
                                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                                <div class="notify-icon"><img src="adm/images/users/user-3.jpg" alt="user-img" class="img-fluid rounded-circle" /> </div>
                                                <p class="notify-details"><b>Thomas J. Mimms</b><span class="text-muted">You have 87 unread messages</span></p>
                                            </a>
    
                                            <!-- item-->
                                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                                <div class="notify-icon"><img src="adm/images/users/user-4.jpg" alt="user-img" class="img-fluid rounded-circle" /> </div>
                                                <p class="notify-details">Luis M. Konrad<span class="text-muted">It is a long established fact that a reader will</span></p>
                                            </a>

                                            <!-- item-->
                                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                                <div class="notify-icon"><img src="adm/images/users/user-5.jpg" alt="user-img" class="img-fluid rounded-circle" /> </div>
                                            ...
                                            <!-- item-->
                                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                                <div class="notify-icon"><img src="adm/images/users/user-6.jpg" alt="user-img" class="img-fluid rounded-circle" /> </div>
                                ...
                                <li class="list-inline-item dropdown notification-list">
                                    <a class="nav-link dropdown-toggle arrow-none waves-effect nav-user" data-toggle="dropdown" href="#" role="button"
                                       aria-haspopup="false" aria-expanded="false">
                                        <img src="adm/images/users/user-1.jpg" alt="user" class="rounded-circle">
                                    </a>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <ul class="list-unstyled activity-list">
                                                ...
                                                <li class="activity-item">
                                                    ...
                                                    <div>
                                                        <a href="#" class="activity-item-img"><img src="adm/images/small/img-1.jpg" alt="" class="rounded mb-2"></a>
                                                        <a href="#" class="activity-item-img"><img src="adm/images/small/img-2.jpg" alt="" class="rounded mb-2"></a>
                                                    </div>
                                                </li>
                                                <li class="activity-item">

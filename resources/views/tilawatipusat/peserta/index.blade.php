                        ...
                        <div class="col-lg-12" >
                            <div class="card">
                                <div class="card-body" >
                                    ...
                                    <button class="text-right btn btn-sm mr-1 btn-outline-info"><i class="fa fa-exports"></i> depan</button>
                                    <button class="text-right btn btn-sm mr-1 btn-info"><i class="fa fa-exports"></i> belakang</button>

            ...
            <form action="{{ route('update.data.peserta') }}" method="POST" enctype="multipart/form-data">@csrf
                <div class="row">
                    ...
                    <div class="form-group col-12 col-xl-6">
                        ...
                        <select name="tmptlahir" id="tmptlahir" class="form-control"
                    ...
                    <div class="form-group col-12 col-xl-6">
                        ...
                        <input placeholder="dd-mm-yyyy" type="date"
                            {{-- value="{{ Carbon\Carbon::parse($peserta->tgllahir)->format('Y-m-d') }}"  --}}
                            name="tgllahir"
                    ...
                    <div class="form-group col-3 col-xl-3">
                        ...
                        <input type="text" id="kode" name="kode" value="62" class="form-control" style="max-height: 40px;"
                            readonly>
                    </div>
                    <div class="form-group col-9 col-xl-6">
                        <label for="phone"><i class="text-danger">*</i> Nomor WA (AKTIF)</label>
                        <input type="number" value="{{ $peserta->telp }}" pattern="[0-9]*" inputmode="numeric" id="phone"
                            onkeypress="return hanyaAngka(event)" name="phone" class="form-control"
                            style="max-height: 40px;">
                        <code style="" id="kodephone"></code>
                    </div>
                    <div class="form-group col-12 col-xl-3">
                        <label for="pos"><i class="text-danger">*</i> Kode Pos</label>
                        <input type="number" value="{{ $peserta->pos }}" id="pos" name="pos" class="form-control"
                            style="max-height: 40px;">
                    ...
                    <div class="form-group  col-12 col-xl-6">
                        ...
                        <select name="kecamatan_id" id="kecamatan_id" class="form-control text-uppercase"
                            style="max-height: 40px; color: rgb(0, 0, 0); font-size: 13px;">
                    ...
                    <div class="form-group  col-12 col-xl-6">
                        ...
                        <select name="kelurahan_id" id="kelurahan_id" class="form-control text-uppercase"
                            style="max-height: 40px; color: rgb(0, 0, 0); font-size: 13px;">
                    ...
                    <div class="form-group  col-12 col-xl-6">
                        ...
                        <input type="text" style="text-transform: uppercase" class="form-control"
                            value="{{ $peserta->kota2 }}" name="kota2">
                    </div>
                    <div class="form-group  col-12 col-xl-6">
                        <label for=""><i class="text-danger"></i> Lembaga</label>
                        <input type="text" style="text-transform: uppercase" class="form-control"
                            value="{{ $peserta->lembaga }}" name="lembaga">
                    </div>
                    ...
                    @if (auth()->user()->role == 'pusat' || auth()->user()->username == 'tilawati cahaya amanah')
                        ...
                        <div class="form-group col-12 col-xl-12">
                            ...
                            <textarea name="kriteria" class="form-control" name="" id="" cols="30"
                                rows="2">{{ $peserta->kriteria }}</textarea>
                        </div>
                    @endif
        ...
        $(document).ready(function() {
            ...
            $('#phone').keyup(function() {
                ...
                if (formatphone != 8) {
                    ...
                    if (phonetxtln > 12) {
                        ...
                        if (phonetxtln < 10) {
                            document.getElementById('kodephone').style.display = "";
                            document.getElementById('kodephone').innerHTML =
                                'format nomor kurang dari 10 digit';
                            $('#daftar').attr('disabled', 'disabled');
                            $('#daftar').addClass('btn btn-danger');
                            $('#daftar').val('Kesalahan Input');
                        } else {
            ...
            $('#phone1').keyup(function() {
                ...
                if (phonetxtln > 12) {
                    ...
                    document.getElementById('kodephone1').innerHTML =
                        'format number cant be more than 12 digit';
                    $('#daftar').attr('disabled', 'disabled');
                    $('#daftar').addClass('btn btn-danger');
                    ...
                    if (phonetxtln < 10) {
                        document.getElementById('kodephone1').style.display = "";
                        document.getElementById('kodephone1').innerHTML =
                            'format number cant be less than 10 digit';
                        $('#daftar').attr('disabled', 'disabled');
                        $('#daftar').addClass('btn btn-danger');
                        $('#daftar').val('Wrong Input');
                    } else {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $.each(data, function(key, value) {
                            $('select[name="kecamatan_id"]').append('<option value="' + key +
                                '">' + value + '</option>');
                        });
            ...
            if (kecamatan_id) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        $('select[name="kelurahan_id"]').empty();
                        $.each(data, function(key, value) {
                            $('select[name="kelurahan_id"]').append('<option value="' + key +
                                '">' + value + '</option>');
                        });

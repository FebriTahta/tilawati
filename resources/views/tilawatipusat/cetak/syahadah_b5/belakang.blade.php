...
<head>
    ...
    @if ($pelatihan->keterangan == 'instruktur')
        <style>
            .bg {
                background-image: url("back_b5.jpg");
                height: 100%; 
                z-index: 1;
    ...
    <center>
        @if ($p->kriteria == 'SEBAGAI INSTRUKTUR LAGU DAN STRATEGI MENGAJAR METODE TILAWATI')
            <div class="cover" style="align-content: center; align-items: center">
                <div>
                    <p  style="margin-top: 160px;" class="syahadah">No. Syahadah : {{ $p->pelatihan->id }}/2022/{{ $p->id }}</p>
                </div>
                <table style="width: 880px; margin-left:85px" class="table1">
                    <tr> 
                            <th rowspan="2">No.</th>
        ...
        @elseif($p->program->name == 'Diklat Munaqisy Cabang')
            <div class="cover" style="align-content: center; align-items: center">
                <div>
                    <p style="margin-top: 140px" class="syahadah">No. Syahadah : {{ $p->pelatihan->id }}/2022/{{ $p->id }}</p>
                </div>
                <table style="width: 782px; margin-left:154px" class="table1">
                    <tr>
                            <th rowspan="2">No.</th>
        ...
        @else
            <div class="cover" style="align-content: center; align-items: center">
                <div>
                    <p style="margin-top: 180px;" class="syahadah">No. Syahadah : {{ $p->pelatihan->id }}/2022/{{ $p->id }}</p>
                </div>
                <table style="width: 782px; margin-left:154px" class="table1">
                    <tr>
                            <th rowspan="2">No.</th>

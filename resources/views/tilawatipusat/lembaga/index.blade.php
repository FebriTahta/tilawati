                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <button class="btn btn-sm btn-success mb-2  mr-1" style="width:130px " data-toggle="modal" data-target=".bs-example-modal-lembaga"><i class="mdi mdi-cloud-upload"></i> import lembaga</button>
                                    <button class="btn btn-sm btn-success mb-2 mr-1" style="width:130px " data-toggle="modal" data-target=".bs-example-modal-tambah-lembaga"><i class="mdi mdi-plus"></i> tambah lembaga</button>
                                                            ...
                                                            <div class="form-group col-sm-12">
                                                                <select name="cabang_id" id="cabang_id" class="form-control" required>
                                                                    ...
                                                                    @foreach ($cabang as $item)
                                                                        <option value="{{ $item->id }}">{{ $item->name }} | {{ $item->kabupaten->nama }}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>

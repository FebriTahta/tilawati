...
/* .bg-gradient-default {
  background: linear-gradient(87deg, #174d40 0, #35c3e7 100%) !important;
} */
              ...
              <div class="text-center">
                <div class="h5">
                  <i class="ni business_briefcase-24 "></i>
                    ...
                    @else
                        @if ($rata2 > 84)
                            <a href="#" class="btn btn-sm btn-info ">BERSYAHADAH</a>
                        @elseif($rata2 < 84 && $rata2 < 75)
                            <a href="#" class="btn btn-sm btn-default">BELUM BERSYAHADAH</a>
                        @else
                            <a href="#" class="btn btn-sm btn-info ">BERSYAHADAH</a>
                        @endif
                    @endif
  ...
  <footer class="footer">
    <div class="row align-items-center justify-content-xl-between">
      <div class="col-xl-6 m-auto text-center">
        <div class="copyright">
          <p>Daftar <a href="https://sertifikat.tilawatipusat.com/" target="_blank">E-Certificate</a> by Tilawati Pusat</p>
        </div>
      </div>
    </div>
  </footer>

...
@section('title') Kode Telephone @endsection
@section('css')
...
@section('content')
    ...
    @component('common-tilawatipusat.breadcrumb')
         @slot('title') KOTA-KABUPATEN   @endslot
         @slot('title_li') INDONESIA   @endslot
    @endcomponent
                    <div class="row">
                        <div class="col-xl-4">
                            @component('common-tilawatipusat.dashboard-widget')
                            
                                @slot('title') <b id="cb"> {{$kabupaten}} </b> Kabupaten  @endslot

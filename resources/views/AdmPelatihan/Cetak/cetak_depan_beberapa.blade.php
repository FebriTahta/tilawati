				...
				<?php
					...
					if (substr($item->kabupaten->nama,5,3)=='ADM') {
						...
						if ($item->kelurahan !== null && $item->kecamatan !== null) {
							# code...
							$text = $item->alamat.' '.substr($item->kelurahan->nama).' '.substr($item->kecamatan->nama).' '.substr($item->kabupaten->nama,10);
						}else {
							# code...
						...
						if ($item->kelurahan !== null && $item->kecamatan !== null) {
							# code...
							$text = $item->alamat.' '.substr($item->kelurahan->nama).' '.substr($item->kecamatan->nama).' '.substr($item->kabupaten->nama,5);
						}else {
							# code...

	...
	<style>
		...
		<div class="print">
			...
			<table style="margin-left:109px; margin-top: 4px">
				...
				<td class="atas" style="width: 241px; height: 27px; text-transform: capitalize">{{ substr($item->pelatihan->cabang->kabupaten->nama, 4) }}, {{ Carbon\Carbon::now()->isoFormat('D MMMM Y') }}</td>
				</tr>

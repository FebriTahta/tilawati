		...
		{{-- @if ($p->pelatihan->keterangan == 'instruktur') --}}	
			@if($p->pelatihan->keterangan == 'instruktur')
				<div style="page-break-inside: avoid">
					...
					<table 
					@if ($p->pelatihan->keterangan == 'instruktur')
					style="width: 880px; margin-left:85px"
					@else
					...
					@endif  class="table1">
						...
						<tr>
							...
							<td>&nbsp; &nbsp;<b> Al-Qur'an</b></td>
							<th  class="pe3"></th>
							<th  class="pe3" style="font-size: 8px">Lagu / Munaqisy</th>
							<th  class="pe3" style="font-size: 8px">Strategi</th>
							<th  class="pe3"></th>
							...
							@if ($item !== null)
								@if ($item->kategori !== 'skill')
									<tr>
										...
										<td class="nilai" style="text-align: center; margin:0; padding:0;">&nbsp; &nbsp;{{ $item->penilaian->max }}</td>
										<td class="nilai2" style="text-align: center; margin:0; padding:0;">&nbsp; &nbsp;{{ $item->penilaian->min}}</td>
										@if ($key < 1)
										<td class="nilai2" style="text-align: center; margin:0; padding:0;">&nbsp; &nbsp;{{ $item->penilaian->min - 1}}</td>
										@else
										<td class="nilai2" style="text-align: center; margin:0; padding:0;">&nbsp; &nbsp;{{ $item->penilaian->min - $z}}</td>
										@endif
										{{-- <td class="nilai2" style="text-align: center">&nbsp; &nbsp;{{ $item->penilaian->min}}</td> --}}
										<td class="nilai3" style="text-align: center">&nbsp; &nbsp;<b>{{ $item->nominal }}</b></td>
								...
								@else
									{{-- <tr>
										...
										<th>{{ $i++ }}</th>
										<td class="nilai6" style="text-transform: uppercase; font-size:10px !important">&nbsp; &nbsp;<b> {{ $item->penilaian->name }}</b></th>

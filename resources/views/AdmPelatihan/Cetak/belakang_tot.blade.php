    ...
    <div class="col-sm-12">
        <div class="float-right page-breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Cetak Ijazah Belakang</li>
            </ol>
        </div>
        <h5 class="page-title">Cetak Ijazah Belakang</h5>
    </div>
</div>
<!-- end row -->
        ...
        <div class="card m-b-30">
            <div class="row">
                <div class="col-12">
                    <div class="card m-b-30">
                        <div class="card-body">                          
                            <form action="{{ route('belakang.cetaktot') }}" method="POST">@csrf
                                <div class="form-group">
                                    ...
                                    <select name="pelatihan_id" id="" class="form-control" required>
                                        ...
                                        @foreach ($dt_pro->pelatihan as $item)

			...
			<div style="page-break-inside: avoid">
				...
				@endif  class="table1">
					...
					<tr>
						...
						<th colspan="3" class="nilai5"></th>
						<th >{{ $rata2 = round(($jumlah+$total)/4, 2) }}</th>
					</tr>
					<tr>
						<th></th>
				...
				@foreach ($p->nilai as $key=> $item)
					@if ($item !== null)
						@if ($item->kategori !== 'skill')
							<tr>
								<td class="pop"></td>
								<td class="pop2" >&nbsp; &nbsp;&nbsp;<span style="text-transform: capitalize">{{ $item->penilaian_id }}</span></td>
								<td class="nilai" style="text-align: center">&nbsp; &nbsp;{{ $item->penilaian_id }}</td>
								<td class="nilai2" style="text-align: center">&nbsp; &nbsp;{{ $item->penilaian_id }}</td>
								<td class="nilai3" style="text-align: center">&nbsp; &nbsp;{{ $item->nominal }}</td>
								<td style="border-top: 0;border-bottom: 0;"></td>
							</tr>
						@else
							<tr>
								<th>{{ $i++ }}</th>
								<td class="nilai6" style="text-transform: uppercase">&nbsp; &nbsp;<b> {{ $item->penilaian_id }}</b></th>
								<th colspan="3" class="nilai5"></th>
								<th >{{ $item->nominal }}</th>
							</tr>
							<?$x++?>

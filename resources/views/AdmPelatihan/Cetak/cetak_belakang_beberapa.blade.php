...
<body>
	...
	@foreach($peserta as $key=> $p)
		...
		@if ($p->pelatihan->program->name == 'TOT Instruktur' && $p->kriteria == 'sebagai instruktur lagu dan strategi mengajar metode tilawati'
		|| $p->kriteria == 'sebagai instruktur lagu metode tilawati')
		{{-- TOT Lulus semuanya --}}
		<div style="page-break-inside: avoid">
			...
			<table 
			@if ($p->pelatihan->keterangan == 'instruktur')
			style="width: 700px; margin-left:358px"
			@else
					...
					@if ($item !== null)
						@if ($item->kategori !== 'skill')
							<tr>
								...
								<td class="nilai" style="text-align: center">&nbsp; &nbsp;{{ $item->penilaian->max }}</td>
								@if ($key < 1)
								<td class="nilai2" style="text-align: center">&nbsp; &nbsp;{{ $item->penilaian->min - $x }}</td>
								@else
